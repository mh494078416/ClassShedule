...
public class ClassSheduleDO {
	...
	public static final String KEY_SUBJECT = "subject"; // 课程
	...
	public static final String KEY_END_TIME = "endTime"; // 结束时间
	...
	public static final String[] COLUMNS = new String[] { ClassSheduleDO.KEY_ID, ClassSheduleDO.KEY_WEEK,
			...
			ClassSheduleDO.KEY_TEACHER, ClassSheduleDO.KEY_START_TIME, ClassSheduleDO.KEY_END_TIME,
			ClassSheduleDO.KEY_INFO, ClassSheduleDO.KEY_SEMESTER_ID };
